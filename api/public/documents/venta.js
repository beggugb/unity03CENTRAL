module.exports = (img1,img2,cotizacion,items, nombres, email,observaciones,fecha,hora) => {
    const today = new Date();  
    var prevLogo = `<img src="${img1}" border="0" alt="logo" width="80" height="80"/>`
    ...
    for(var i in items){
        ...
        coberturas += "<td width='10%' class='cobet'>"+cotizacion.nroItems+"</td>";
        coberturas += "<td width='10%' class='cobet'>"+parseFloat(cotizacion.total).toFixed(2)+" Bs.</td>";                        
        coberturas += "</tr>";
 coberturas += "</table>"; 
   ...
   return `<html>
     ...
     <body>
       <div class="page">
         ...
         ${prevLogo}
         <h5>Cotización # ${cotizacion.id}</h5>      
           <div class="cliente">                   
             <table class="table-datos">
               <tr>
                 <td width="10%"><b>Nro  :</b></td>                            
                 <td width="20%">${cotizacion.id}</td>            
                 <td width="10%"><b>Fecha :</b></td>                            
                 <td width="20%">${cotizacion.fechaVenta}</td>            
                 <td width="10%"><b>Nº Items :</b></td>
                 <td width="10%">${cotizacion.nroItems}</td>                      
                 <td width="10%"><b>Total :</b></td>                                    
                 <td width="10%">${parseFloat(cotizacion.total).toFixed(2)} Bs.</td>
               </tr>               
             </table>
           </div>
